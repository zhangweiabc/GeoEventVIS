...
var tipshow = function(d,id) {
  ...
  tooltipdiv.html(function() {
      ...
      else if(id=="eventstory1") {showcontent=d;console.log(d);}
      else if(id=="eventstory2") {showcontent=d.id;console.log(d);}
      else if(id=="Circularheat") {showcontent=d;console.log(d);}
...
////////////////////////////平行坐标/////////////////////////////////////////////
////////////////////////////Sunburst/////////////////////////////////////////////
function DrawSunburst(svg,w,h,r,x,y,data) {
  var arc = d3.svg.arc()
...
////////////////////////////Sunburst/////////////////////////////////////////////
////////////////////////////RadialTeee/////////////////////////////////////////////
function DrawRadialTree(svg,diameter,h)
{
...
////////////////////////////HeatMap/////////////////////////////////////////////
////////////////////////////ForceGraph/////////////////////////////////////////////
function DrawForceGraph(svg,width,height)
{
  var  root;
...
///////////////////////////////////////////////////////////////////////
function DrawCircularheat(dviID,w,h)
{
  var data = [];
...
//////////////////////////////////////////////////////////////////////////////
/////////////////////////////////DrawBarChart/////////////////////////////////////
function DrawBarChart(divID,w,h)
{
...
/////////////////////////////////////////////////////////////////////////
///////////////////////////////DrawCircleChart////////////////////////////////////
function DrawCircleChart(divID,w,h)
{
...
///////////////////////////////DrawCircleChart////////////////////////////////////
///////////////////////////////DrawStackedBarChart////////////////////////////////////
function DrawStackedBarChart(divID,w,h)
{
...
///////////////////////////////DrawStackedBarChart////////////////////////////////////
///////////////////////////////DrawMultiLine////////////////////////////////////
function DrawMultiLine(divID,w,h)
{
...
///////////////////////////////DrawMultiLine////////////////////////////////////
///////////////////////////////DrawScatterPlot////////////////////////////////////
function DrawScatterPlot(divID,w,h)
{
  var margin = {top: 20, right: 20, bottom: 30, left: 40},
    width = w - margin.left - margin.right,
    height = h - margin.top - margin.bottom;
...
function Draw3DDonut(divID,w,h)
{
  var salesData=[
...
///////////////////////////////Draw3DDonut////////////////////////////////////
///////////////////////////////DrawTreeMap////////////////////////////////////
function DrawTreeMap(divID,w,h)
{
...
///////////////////////////////DrawTreeMap////////////////////////////////////
///////////////////////////////DrawAreaTime////////////////////////////////////
function DrawAreaTime(divID,w,h)
{
...
///////////////////////////////DrawAreaTime///////////////////////////////////
///////////////////////////////DrawCirclePacking///////////////////////////////////
function DrawCirclePacking(divID,w,h,r)
{
...
///////////////////////////////DrawCirclePacking///////////////////////////////////
///////////////////////////////DrawFlameGraph///////////////////////////////////
function DrawFlameGraph(divID,w,h)
{
...
///////////////////////////////DrawFlameGraph///////////////////////////////////
function DrawWordCloud(svg,width,height,wordsdata)
{
