...
function brushedsl() {
	...
	currentTranslate= SVGMap.zoomMap.translate();

	currentScale = value;
	SVGMap.zoomMap.scale(value);
...
d3.select("#pantool").append("g")
  .append("input")
  .attr("id","ptbuttonAirport")
  .attr("type","button")
  .attr("value","机场")
  .on("click",function(){});
d3.select("#pantool").append("g")
  .append("input")
  .attr("id","ptbuttonPoints")
  .attr("type","button")
  .attr("value","点标")
  .on("click",function(){});
d3.select("#pantool").append("g")
  .append("input")
  .attr("id","ptbuttonLines")
  .attr("type","button")
  .attr("value","线标")
  .on("click",function(){});
d3.select("#pantool").append("g")
  .append("input")
  .attr("id","ptbuttonAreas")
  .attr("type","button")
  .attr("value","面域")
  .on("click",function(){});
d3.select("#pantool").append("g")
  .append("input")
  .attr("id","ptbuttonHeat")
  .attr("type","button")
  .attr("value","场域")
  .on("click",function(){});
d3.select("#pantool").append("g")
